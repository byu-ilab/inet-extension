...
#include "TCPSessionApp2.h"
#include "IPAddressResolver.h"


Define_Module(TCPSessionApp2);


void TCPSessionApp2::parseScript(const char *script)
{
    const char *s = script;
    while (*s)
    {
...
void TCPSessionApp2::count(cMessage *msg)
{
...
void TCPSessionApp2::waitUntil(simtime_t t)
{
    if (simTime()>=t)
        return;
