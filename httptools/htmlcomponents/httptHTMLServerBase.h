...
// Originally was the httptServerBase, but as it is specific to HTML
// the generic server parts were factored out into the httptServerBase
// and this became the httptHTMLServerBase.

// contributors: Kevin Black
 ...
 */
class INET_API httptHTMLServerBase : public httptServerBase /*httptNodeBase*/
{
  	protected:
	...
	protected:
		...
		// inherited from httptServerBase
