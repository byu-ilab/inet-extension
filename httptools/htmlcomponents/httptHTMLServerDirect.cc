...
#include "httptHTMLServerDirect.h"

Define_Module(httptHTMLServerDirect);

void httptHTMLServerDirect::initialize()
{
...
void httptHTMLServerDirect::finish()
{
	httptHTMLServerBase::finish();
}

void httptHTMLServerDirect::handleMessage(cMessage *msg)
{
