...
#include "httptHTMLServerDirectEvilA.h"

Define_Module(httptHTMLServerDirectEvilA);

void httptHTMLServerDirectEvilA::initialize()
{
	httptHTMLServerDirect::initialize();
...
std::string httptHTMLServerDirectEvilA::generateBody()
{
