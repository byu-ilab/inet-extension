...
#include "httptHTMLServerDirectEvilB.h"

Define_Module(httptHTMLServerDirectEvilB);

void httptHTMLServerDirectEvilB::initialize()
{
...
std::string httptHTMLServerDirectEvilB::generateBody()
{
