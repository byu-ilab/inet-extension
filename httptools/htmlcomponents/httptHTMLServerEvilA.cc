...
#include "httptHTMLServerEvilA.h"

Define_Module(httptHTMLServerEvilA);

void httptHTMLServerEvilA::initialize()
{
	httptHTMLServer::initialize();
...
std::string httptHTMLServerEvilA::generateBody()
{
